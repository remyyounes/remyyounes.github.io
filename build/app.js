...
var _remyyounes$elm_snake$Utils_Math$wrap = F2(
	function (v, range) {
		var max = range - 1;
		var min = 0;
		return (_elm_lang$core$Native_Utils.cmp(v, min) < 0) ? max : ((_elm_lang$core$Native_Utils.cmp(v, max) > 0) ? min : v);
	});
var _remyyounes$elm_snake$Utils_Math$lerp = F3(
	function (min, max, val) {
		return min + ((max - min) * val);
	});

var _remyyounes$elm_snake$Tile$cornerOrientation = function (orientation) {
	var _p0 = orientation;
	switch (_p0) {
		case 'UpRight':
			return 270.0;
...
var _remyyounes$elm_snake$Tile$getOrientation = function (orientation) {
	var _p1 = orientation;
	switch (_p1) {
		case 'UpUp':
			return 0.0;
...
var _remyyounes$elm_snake$Tile$corner = F2(
	function (color, size) {
		return _evancz$elm_graphics$Collage$group(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					color,
					_evancz$elm_graphics$Collage$circle(size / 2)),
					A2(
					_evancz$elm_graphics$Collage$move,
					{ctor: '_Tuple2', _0: 0, _1: size / 4},
					A2(
						_evancz$elm_graphics$Collage$filled,
						color,
						A2(_evancz$elm_graphics$Collage$rect, size, size / 2))),
					A2(
					_evancz$elm_graphics$Collage$move,
					{ctor: '_Tuple2', _0: size / 4, _1: 0},
					A2(
						_evancz$elm_graphics$Collage$filled,
						color,
						A2(_evancz$elm_graphics$Collage$rect, size / 2, size)))
				]));
	});
var _remyyounes$elm_snake$Tile$triangle = function (size) {
	return _evancz$elm_graphics$Collage$polygon(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: (0 - size) / 2, _1: size / 2},
				{ctor: '_Tuple2', _0: size / 2, _1: size / 2},
				{ctor: '_Tuple2', _0: 0, _1: (0 - size) / 2}
			]));
};
var _remyyounes$elm_snake$Tile$tiles = 20;
var _remyyounes$elm_snake$Tile$tile = 30;
var _remyyounes$elm_snake$Tile$world = {width: _remyyounes$elm_snake$Tile$tiles * _remyyounes$elm_snake$Tile$tile, height: _remyyounes$elm_snake$Tile$tiles * _remyyounes$elm_snake$Tile$tile};
var _remyyounes$elm_snake$Tile$placeTile = F2(
	function (position, form) {
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: (0 - _remyyounes$elm_snake$Tile$world.width) / 2, _1: (0 - _remyyounes$elm_snake$Tile$world.height) / 2},
			A2(
				_evancz$elm_graphics$Collage$move,
				{ctor: '_Tuple2', _0: _remyyounes$elm_snake$Tile$tile / 2, _1: _remyyounes$elm_snake$Tile$tile / 2},
				A2(
					_evancz$elm_graphics$Collage$move,
					{ctor: '_Tuple2', _0: position.x * _remyyounes$elm_snake$Tile$tile, _1: position.y * _remyyounes$elm_snake$Tile$tile},
					form)));
	});
var _remyyounes$elm_snake$Tile$viewFruit = F3(
	function (color, position, orientation) {
		return A2(
			_remyyounes$elm_snake$Tile$placeTile,
			position,
			A2(
				_evancz$elm_graphics$Collage$filled,
				color,
				_evancz$elm_graphics$Collage$circle(_remyyounes$elm_snake$Tile$tile / 4)));
	});
var _remyyounes$elm_snake$Tile$viewTail = F3(
	function (color, position, direction) {
		return A2(
			_remyyounes$elm_snake$Tile$placeTile,
			position,
			A2(
				...
				_elm_lang$core$Basics$degrees(
					_remyyounes$elm_snake$Tile$getOrientation(direction)),
				A2(
					_evancz$elm_graphics$Collage$filled,
					color,
					_remyyounes$elm_snake$Tile$triangle(_remyyounes$elm_snake$Tile$tile))));
	});
var _remyyounes$elm_snake$Tile$viewHead = F3(
	function (color, position, direction) {
		return A2(
			_remyyounes$elm_snake$Tile$placeTile,
			position,
				...
				_evancz$elm_graphics$Collage$group(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_evancz$elm_graphics$Collage$filled,
							color,
							_evancz$elm_graphics$Collage$circle(_remyyounes$elm_snake$Tile$tile / 2)),
							A2(
							_evancz$elm_graphics$Collage$move,
							{ctor: '_Tuple2', _0: 0, _1: (0 - _remyyounes$elm_snake$Tile$tile) / 4},
							A2(
								_evancz$elm_graphics$Collage$filled,
								color,
								A2(_evancz$elm_graphics$Collage$rect, _remyyounes$elm_snake$Tile$tile, _remyyounes$elm_snake$Tile$tile / 2))),
							A2(
							_evancz$elm_graphics$Collage$move,
							{ctor: '_Tuple2', _0: (0 - _remyyounes$elm_snake$Tile$tile) / 4, _1: 0},
							A2(
								_evancz$elm_graphics$Collage$filled,
								_elm_lang$core$Color$black,
								_evancz$elm_graphics$Collage$circle(_remyyounes$elm_snake$Tile$tile / 10))),
							A2(
							_evancz$elm_graphics$Collage$move,
							{ctor: '_Tuple2', _0: _remyyounes$elm_snake$Tile$tile / 4, _1: 0},
							A2(
								_evancz$elm_graphics$Collage$filled,
								_elm_lang$core$Color$black,
								_evancz$elm_graphics$Collage$circle(_remyyounes$elm_snake$Tile$tile / 10)))
...
var _remyyounes$elm_snake$Tile$patternTile = F2(
	function (color, size) {
		return _evancz$elm_graphics$Collage$group(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_evancz$elm_graphics$Collage$filled,
					color,
					_evancz$elm_graphics$Collage$square(_remyyounes$elm_snake$Tile$tile)),
					A2(
					_evancz$elm_graphics$Collage$rotate,
					_elm_lang$core$Basics$degrees(90),
					A2(
						_evancz$elm_graphics$Collage$filled,
						A4(_elm_lang$core$Color$rgba, 0, 0, 0, 0.2),
						_remyyounes$elm_snake$Tile$triangle(size)))
				]));
	});
var _remyyounes$elm_snake$Tile$getShape = F2(
	function (color, orientation) {
		var tAngle = _elm_lang$core$Basics$degrees(
			_remyyounes$elm_snake$Tile$getOrientation(orientation));
		var cAngle = _elm_lang$core$Basics$degrees(
			_remyyounes$elm_snake$Tile$cornerOrientation(orientation));
		var shape = function () {
			var _p2 = orientation;
			switch (_p2) {
				case 'UpRight':
					return A2(
						_evancz$elm_graphics$Collage$rotate,
						cAngle,
						A2(_remyyounes$elm_snake$Tile$corner, color, _remyyounes$elm_snake$Tile$tile));
				case 'UpLeft':
					return A2(
						_evancz$elm_graphics$Collage$rotate,
						cAngle,
				...
				default:
					return A2(
						_evancz$elm_graphics$Collage$rotate,
						tAngle,
						A2(_remyyounes$elm_snake$Tile$patternTile, color, _remyyounes$elm_snake$Tile$tile));
			}
		}();
		return shape;
	});
var _remyyounes$elm_snake$Tile$view = F3(
	function (color, position, orientation) {
		return A2(
			_remyyounes$elm_snake$Tile$placeTile,
			position,
			A2(_remyyounes$elm_snake$Tile$getShape, color, orientation));
	});

var _remyyounes$elm_snake$Position$vecEql = F2(
	function (vecA, vecB) {
		return _elm_lang$core$Native_Utils.eq(vecA.x, vecB.x) && _elm_lang$core$Native_Utils.eq(vecA.y, vecB.y);
	});
var _remyyounes$elm_snake$Position$detectCollision = F2(
	function (head, tail) {
		var collided = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (tile, m) {
					return m || A2(_remyyounes$elm_snake$Position$vecEql, head, tile);
				}),
			false,
			tail);
		return collided ? true : _remyyounes$elm_snake$Position$detectCollisions(tail);
	});
var _remyyounes$elm_snake$Position$detectCollisions = function (body) {
	var _p0 = _elm_lang$core$List$tail(body);
	if (_p0.ctor === 'Nothing') {
		return false;
	} else {
		var _p1 = _elm_lang$core$List$head(body);
		if (_p1.ctor === 'Nothing') {
			return false;
		} else {
			return A2(_remyyounes$elm_snake$Position$detectCollision, _p1._0, _p0._0);
		}
	}
};
var _remyyounes$elm_snake$Position$Vector = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _remyyounes$elm_snake$Position$wrapPosition = F2(
	function (world, position) {
		return A2(
			_remyyounes$elm_snake$Position$Vector,
			A2(_remyyounes$elm_snake$Utils_Math$wrap, position.x, _remyyounes$elm_snake$Tile$tiles),
			A2(_remyyounes$elm_snake$Utils_Math$wrap, position.y, _remyyounes$elm_snake$Tile$tiles));
	});
var _remyyounes$elm_snake$Position$Dimensions = F2(
	function (a, b) {
		return {width: a, height: b};
	});

var _remyyounes$elm_snake$Utils_Color$greyedColor = F2(
	function (color, val) {
		var grey = (val / 3) | 0;
		var _p0 = color;
		switch (_p0.ctor) {
			case 'Red':
				return A3(_elm_lang$core$Color$rgb, val, grey, grey);
			case 'Green':
				return A3(_elm_lang$core$Color$rgb, grey, val, grey);
			default:
				return A3(_elm_lang$core$Color$rgb, grey, grey, val);
		}
	});
var _remyyounes$elm_snake$Utils_Color$lerpFromPosition = F4(
	function (min, max, idx, length) {
		return _elm_lang$core$Basics$round(
			A3(
				_remyyounes$elm_snake$Utils_Math$lerp,
				min,
				max,
				_elm_lang$core$Basics$toFloat(idx) / _elm_lang$core$Basics$toFloat(length)));
	});
var _remyyounes$elm_snake$Utils_Color$Blue = {ctor: 'Blue'};
var _remyyounes$elm_snake$Utils_Color$Green = {ctor: 'Green'};
var _remyyounes$elm_snake$Utils_Color$ringColor = F2(
	function (idx, length) {
		return A2(
			_remyyounes$elm_snake$Utils_Color$greyedColor,
			_remyyounes$elm_snake$Utils_Color$Green,
			A4(_remyyounes$elm_snake$Utils_Color$lerpFromPosition, 100, 200, idx, length));
	});
var _remyyounes$elm_snake$Utils_Color$Red = {ctor: 'Red'};
var _remyyounes$elm_snake$Utils_Color$fruitColor = F2(
	function (bonus, maxBonus) {
		return A2(
			_remyyounes$elm_snake$Utils_Color$greyedColor,
			_remyyounes$elm_snake$Utils_Color$Red,
			A4(_remyyounes$elm_snake$Utils_Color$lerpFromPosition, 100, 200, bonus, maxBonus));
	});

var _remyyounes$elm_snake$Fruit$view = function (fruit) {
	return A3(
		_remyyounes$elm_snake$Tile$viewFruit,
		A2(_remyyounes$elm_snake$Utils_Color$fruitColor, fruit.bonus, fruit.maxBonus),
		fruit.pos,
		'');
};
var _remyyounes$elm_snake$Fruit$update = function (fruit) {
	return _elm_lang$core$Native_Utils.update(
		fruit,
		{bonus: fruit.bonus - 1});
};
var _remyyounes$elm_snake$Fruit$maxBonus = 100;
var _remyyounes$elm_snake$Fruit$init = F2(
	function (x, y) {
		return {
			pos: A2(
				_remyyounes$elm_snake$Position$Vector,
			...
			bonus: _remyyounes$elm_snake$Fruit$maxBonus,
			maxBonus: _remyyounes$elm_snake$Fruit$maxBonus
		};
	});
var _remyyounes$elm_snake$Fruit$Fruit = F3(
	function (a, b, c) {
		return {pos: a, bonus: b, maxBonus: c};
	});

var _remyyounes$elm_snake$SnakeMsg$NewFruit = function (a) {
	return {ctor: 'NewFruit', _0: a};
};
var _remyyounes$elm_snake$SnakeMsg$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _remyyounes$elm_snake$SnakeMsg$ChangeDirection = function (a) {
	return {ctor: 'ChangeDirection', _0: a};
};
var _remyyounes$elm_snake$SnakeMsg$NoOp = {ctor: 'NoOp'};
var _remyyounes$elm_snake$SnakeMsg$Start = {ctor: 'Start'};

var _remyyounes$elm_snake$SnakeKeyboard$Unknown = {ctor: 'Unknown'};
var _remyyounes$elm_snake$SnakeKeyboard$ArrowUp = {ctor: 'ArrowUp'};
var _remyyounes$elm_snake$SnakeKeyboard$ArrowDown = {ctor: 'ArrowDown'};
var _remyyounes$elm_snake$SnakeKeyboard$ArrowRight = {ctor: 'ArrowRight'};
var _remyyounes$elm_snake$SnakeKeyboard$ArrowLeft = {ctor: 'ArrowLeft'};
var _remyyounes$elm_snake$SnakeKeyboard$Space = {ctor: 'Space'};
var _remyyounes$elm_snake$SnakeKeyboard$fromCode = function (keyCode) {
	var _p0 = keyCode;
	switch (_p0) {
		case 32:
			return _remyyounes$elm_snake$SnakeKeyboard$Space;
		case 38:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowUp;
		case 39:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowRight;
		case 40:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowDown;
		case 37:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowLeft;
		case 87:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowUp;
		case 68:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowRight;
		...
		case 65:
			return _remyyounes$elm_snake$SnakeKeyboard$ArrowLeft;
		default:
			return _remyyounes$elm_snake$SnakeKeyboard$Unknown;
	}
};
var _remyyounes$elm_snake$SnakeKeyboard$keyboardProcessor = function (keyCode) {
	var _p1 = _remyyounes$elm_snake$SnakeKeyboard$fromCode(keyCode);
	switch (_p1.ctor) {
		case 'Space':
			return _remyyounes$elm_snake$SnakeMsg$Start;
		case 'ArrowDown':
			return _remyyounes$elm_snake$SnakeMsg$ChangeDirection('Down');
		case 'ArrowLeft':
			return _remyyounes$elm_snake$SnakeMsg$ChangeDirection('Left');
		case 'ArrowRight':
			return _remyyounes$elm_snake$SnakeMsg$ChangeDirection('Right');
		case 'ArrowUp':
			return _remyyounes$elm_snake$SnakeMsg$ChangeDirection('Up');
		default:
			return _remyyounes$elm_snake$SnakeMsg$NoOp;
	}
};

var _remyyounes$elm_snake$Snake$view = function (snake) {
	var length = _elm_lang$core$List$length(snake.body);
	return _elm_lang$core$List$reverse(
		A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (idx, ring) {
					var color = A2(_remyyounes$elm_snake$Utils_Color$ringColor, length - idx, length);
					return _elm_lang$core$Native_Utils.eq(idx, 0) ? A3(_remyyounes$elm_snake$Tile$viewHead, _elm_lang$core$Color$green, ring.pos, ring.orientation) : (_elm_lang$core$Native_Utils.eq(idx, length - 1) ? A3(_remyyounes$elm_snake$Tile$viewTail, color, ring.pos, ring.orientation) : A3(_remyyounes$elm_snake$Tile$view, color, ring.pos, ring.orientation));
				}),
			snake.body));
};
var _remyyounes$elm_snake$Snake$restrictDirection = F2(
	function (previous, next) {
		var _p0 = next;
		switch (_p0) {
			case 'Right':
				return _elm_lang$core$Native_Utils.eq(previous, 'Left') ? previous : next;
			case 'Left':
				return _elm_lang$core$Native_Utils.eq(previous, 'Right') ? previous : next;
			case 'Up':
				return _elm_lang$core$Native_Utils.eq(previous, 'Down') ? previous : next;
			case 'Down':
				return _elm_lang$core$Native_Utils.eq(previous, 'Up') ? previous : next;
			default:
				return next;
		}
	});
var _remyyounes$elm_snake$Snake$updatePosition = F2(
	function (direction, pos) {
		var _p1 = direction;
		switch (_p1) {
			case 'Right':
				return A2(_remyyounes$elm_snake$Position$Vector, pos.x + 1, pos.y);
			case 'Left':
				return A2(_remyyounes$elm_snake$Position$Vector, pos.x - 1, pos.y);
			case 'Up':
				return A2(_remyyounes$elm_snake$Position$Vector, pos.x, pos.y + 1);
			case 'Down':
				return A2(_remyyounes$elm_snake$Position$Vector, pos.x, pos.y - 1);
			default:
				return pos;
...
var _remyyounes$elm_snake$Snake$setOrientation = F2(
	function (orientation, ring) {
		return _elm_lang$core$Native_Utils.update(
			ring,
			{orientation: orientation});
	});
var _remyyounes$elm_snake$Snake$growSnake = function (snake) {
	var length = _elm_lang$core$List$length(snake.body) - 1;
	return _elm_lang$core$Native_Utils.update(
		snake,
		{
			body: A2(
				_elm_lang$core$List$append,
				snake.body,
				A2(_elm_lang$core$List$drop, length, snake.body))
		});
};
var _remyyounes$elm_snake$Snake$wrapSnakePosition = F2(
	function (bounds, snake) {
		return _elm_lang$core$Native_Utils.update(
			snake,
			{
				pos: A2(_remyyounes$elm_snake$Position$wrapPosition, _remyyounes$elm_snake$Tile$world, snake.pos)
			});
	});
var _remyyounes$elm_snake$Snake$updateSnakePosition = F2(
	function (direction, snake) {
		return _elm_lang$core$Native_Utils.update(
			snake,
			{
				pos: A2(_remyyounes$elm_snake$Snake$updatePosition, direction, snake.pos)
			});
	});
var _remyyounes$elm_snake$Snake$rememberDirection = function (snake) {
	return _elm_lang$core$Native_Utils.update(
		snake,
		{previousDirection: snake.direction});
};
var _remyyounes$elm_snake$Snake$tailToHead = F2(
	function (leader, body) {
		return A2(
			_elm_lang$core$List$append,
			_elm_lang$core$Native_List.fromArray(
				[leader]),
			A2(
				...
				_elm_lang$core$List$length(body) - 1,
				body));
	});
var _remyyounes$elm_snake$Snake$updateSnakeBody = function (snake) {
	var orientationPrev = A2(_elm_lang$core$Basics_ops['++'], snake.previousDirection, snake.direction);
	var prevBody = A2(
		_elm_lang$core$List$append,
		A2(
			_elm_lang$core$List$map,
			_remyyounes$elm_snake$Snake$setOrientation(orientationPrev),
			A2(_elm_lang$core$List$take, 1, snake.body)),
		A2(_elm_lang$core$List$drop, 1, snake.body));
	var orientationCur = A2(_elm_lang$core$Basics_ops['++'], snake.direction, snake.direction);
	var head = {pos: snake.pos, orientation: orientationCur};
	return _elm_lang$core$Native_Utils.update(
		snake,
		{
			body: A2(_remyyounes$elm_snake$Snake$tailToHead, head, prevBody)
		});
};
var _remyyounes$elm_snake$Snake$update = F2(
	function (msg, snake) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Tick':
				return _remyyounes$elm_snake$Snake$rememberDirection(
					_remyyounes$elm_snake$Snake$updateSnakeBody(
						A2(
							_remyyounes$elm_snake$Snake$wrapSnakePosition,
							_remyyounes$elm_snake$Tile$world,
							A2(_remyyounes$elm_snake$Snake$updateSnakePosition, snake.direction, snake))));
			case 'ChangeDirection':
				return _elm_lang$core$Native_Utils.update(
					snake,
					{
						direction: A2(_remyyounes$elm_snake$Snake$restrictDirection, snake.previousDirection, _p2._0)
					});
			default:
				return snake;
		}
	});
var _remyyounes$elm_snake$Snake$Ring = F2(
	function (a, b) {
		return {pos: a, orientation: b};
	});
var _remyyounes$elm_snake$Snake$Snake = F4(
	function (a, b, c, d) {
		return {pos: a, body: b, direction: c, previousDirection: d};
	});

var _remyyounes$elm_snake$SnakeGame$viewGame = function (game) {
	return A2(
		_evancz$elm_graphics$Element$color,
		_elm_lang$core$Color$grey,
		A3(
			_evancz$elm_graphics$Collage$collage,
			_remyyounes$elm_snake$Tile$world.width,
			_remyyounes$elm_snake$Tile$world.height,
			A2(
				_elm_lang$core$List$append,
				_elm_lang$core$Native_List.fromArray(
					[
						_remyyounes$elm_snake$Fruit$view(game.fruit)
					]),
				_remyyounes$elm_snake$Snake$view(game.snake))));
};
var _remyyounes$elm_snake$SnakeGame$initSnakeLength = 3;
var _remyyounes$elm_snake$SnakeGame$initPos = F2(
	function (length, pos) {
		return A2(
			_remyyounes$elm_snake$Position$Vector,
			_elm_lang$core$Basics$toFloat(length - pos),
			0.0);
	});
var _remyyounes$elm_snake$SnakeGame$initRing = F2(
	function (length, pos) {
		return {
			orientation: 'RightRight',
			pos: A2(_remyyounes$elm_snake$SnakeGame$initPos, length, pos)
		};
	});
var _remyyounes$elm_snake$SnakeGame$initSnake = function () {
	var offset = (_remyyounes$elm_snake$SnakeGame$initSnakeLength / 2) | 0;
	return {
		pos: A2(_remyyounes$elm_snake$SnakeGame$initPos, _remyyounes$elm_snake$SnakeGame$initSnakeLength, 1),
		body: A2(
			_elm_lang$core$List$map,
			_remyyounes$elm_snake$SnakeGame$initRing(_remyyounes$elm_snake$SnakeGame$initSnakeLength),
			_elm_lang$core$Native_List.range(1, _remyyounes$elm_snake$SnakeGame$initSnakeLength)),
		direction: 'Right',
		previousDirection: 'Right'
	};
}();
var _remyyounes$elm_snake$SnakeGame$maxBonus = 100;
var _remyyounes$elm_snake$SnakeGame$fps = 10;
var _remyyounes$elm_snake$SnakeGame$timePerFrame = 1000 / _remyyounes$elm_snake$SnakeGame$fps;
var _remyyounes$elm_snake$SnakeGame$Game = F7(
	function (a, b, c, d, e, f, g) {
		return {score: a, previousDirection: b, direction: c, lastFrameDelta: d, fruit: e, state: f, snake: g};
	});
var _remyyounes$elm_snake$SnakeGame$Playing = {ctor: 'Playing'};
var _remyyounes$elm_snake$SnakeGame$initGame = {
	score: 0,
	previousDirection: 'Right',
	direction: 'Right',
	lastFrameDelta: 0,
	fruit: A2(_remyyounes$elm_snake$Fruit$init, 6, 0),
	state: _remyyounes$elm_snake$SnakeGame$Playing,
	snake: _remyyounes$elm_snake$SnakeGame$initSnake
};
var _remyyounes$elm_snake$SnakeGame$Over = {ctor: 'Over'};
var _remyyounes$elm_snake$SnakeGame$stepGame = F2(
	function (msg, game) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeDirection':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						game,
						{
							snake: A2(_remyyounes$elm_snake$Snake$update, msg, game.snake)
						}),
			...
			case 'Tick':
				...
				var score = _p1.score;
				var snake = _p1.snake;
				var lastFrameDelta = _p1.lastFrameDelta;
				var direction = _p1.direction;
				var fruit = _p1.fruit;
				var ateFruit = A2(_remyyounes$elm_snake$Position$vecEql, snake.pos, fruit.pos);
				var cmds = ateFruit ? A2(
					_elm_lang$core$Random$generate,
					_remyyounes$elm_snake$SnakeMsg$NewFruit,
					A2(
						_elm_lang$core$Random$pair,
						A2(_elm_lang$core$Random$int, 0, _remyyounes$elm_snake$Tile$tiles - 1),
						A2(_elm_lang$core$Random$int, 0, _remyyounes$elm_snake$Tile$tiles - 1))) : _elm_lang$core$Platform_Cmd$none;
				var grownSnake = ateFruit ? _remyyounes$elm_snake$Snake$growSnake(snake) : snake;
				var updatedSnake = A2(_remyyounes$elm_snake$Snake$update, msg, grownSnake);
				var ateTail = _remyyounes$elm_snake$Position$detectCollisions(
					A2(
						_elm_lang$core$List$map,
						function (_) {
							return _.pos;
						...
						updatedSnake.body));
				var gameState = (ateTail || _elm_lang$core$Native_Utils.eq(game.state, _remyyounes$elm_snake$SnakeGame$Over)) ? _remyyounes$elm_snake$SnakeGame$Over : _remyyounes$elm_snake$SnakeGame$Playing;
				var updatedFruit = _remyyounes$elm_snake$Fruit$update(fruit);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						game,
						{score: score, fruit: updatedFruit, state: gameState, previousDirection: direction, snake: updatedSnake}),
					_1: cmds
				};
			default:
...
var _remyyounes$elm_snake$SnakeGame$updateGame = F2(
	function (msg, game) {
		var _p2 = msg;
		_v1_3:
		do {
			switch (_p2.ctor) {
				case 'ChangeDirection':
					return A2(_remyyounes$elm_snake$SnakeGame$stepGame, msg, game);
				case 'NewFruit':
					if (_p2._0.ctor === '_Tuple2') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								game,
								{
									fruit: A2(_remyyounes$elm_snake$Fruit$init, _p2._0._0, _p2._0._1)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
				...
				case 'Tick':
					var newDelta = game.lastFrameDelta + _p2._0;
					var ticked = (_elm_lang$core$Native_Utils.cmp(newDelta, _remyyounes$elm_snake$SnakeGame$timePerFrame) > 0) && _elm_lang$core$Native_Utils.eq(game.state, _remyyounes$elm_snake$SnakeGame$Playing);
					var newFrameDelta = function () {
						var _p3 = ticked;
						if (_p3 === true) {
							return game.lastFrameDelta - _remyyounes$elm_snake$SnakeGame$timePerFrame;
						} else {
							return newDelta;
						}
					}();
					var g = _elm_lang$core$Native_Utils.update(
						game,
						{lastFrameDelta: newFrameDelta});
					return ticked ? A2(_remyyounes$elm_snake$SnakeGame$stepGame, msg, g) : {ctor: '_Tuple2', _0: g, _1: _elm_lang$core$Platform_Cmd$none};
				default:
					break _v1_3;
			}
		} while(false);
...
var _remyyounes$elm_snake$Main$instructions = _elm_lang$html$Html$text('A,W,S,D / ⇨, ⇩, ⇦, ⇧  --  SPACE');
var _remyyounes$elm_snake$Main$instructionsStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _remyyounes$elm_snake$Main$containerStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'backgroundColor', _1: 'rgb(238, 238, 236)'},
...
var _remyyounes$elm_snake$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_remyyounes$elm_snake$Main$containerStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_remyyounes$elm_snake$SnakeGame$viewGame(model.game)),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[_remyyounes$elm_snake$Main$instructionsStyle]),
						_elm_lang$core$Native_List.fromArray(
							[_remyyounes$elm_snake$Main$instructions]))
					]))
			]));
};
var _remyyounes$elm_snake$Main_ops = _remyyounes$elm_snake$Main_ops || {};
_remyyounes$elm_snake$Main_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _remyyounes$elm_snake$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$downs(_remyyounes$elm_snake$SnakeKeyboard$keyboardProcessor),
				_elm_lang$animation_frame$AnimationFrame$diffs(_remyyounes$elm_snake$SnakeMsg$Tick)
			]));
};
var _remyyounes$elm_snake$Main$Model = function (a) {
	return {game: a};
};
var _remyyounes$elm_snake$Main$init = {
	ctor: '_Tuple2',
	_0: _remyyounes$elm_snake$Main$Model(_remyyounes$elm_snake$SnakeGame$initGame),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _remyyounes$elm_snake$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'Start':
				return _remyyounes$elm_snake$Main$init;
			case 'NewFruit':
				var _p1 = A2(_remyyounes$elm_snake$SnakeGame$updateGame, msg, model.game);
				var game = _p1._0;
				var cmds = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: _remyyounes$elm_snake$Main$Model(game),
					_1: cmds
				};
			case 'ChangeDirection':
				var _p2 = A2(_remyyounes$elm_snake$SnakeGame$updateGame, msg, model.game);
				var game = _p2._0;
				var cmds = _p2._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				var _p3 = A2(_remyyounes$elm_snake$SnakeGame$updateGame, msg, model.game);
				var game = _p3._0;
				var cmds = _p3._1;
				return {
					ctor: '_Tuple2',
...
var _remyyounes$elm_snake$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _remyyounes$elm_snake$Main$init, view: _remyyounes$elm_snake$Main$view, update: _remyyounes$elm_snake$Main$update, subscriptions: _remyyounes$elm_snake$Main$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _remyyounes$elm_snake$Main$main === 'undefined' ? null : _remyyounes$elm_snake$Main$main);
